        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            ...
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">{{}} <del style="" class="subtitle-1 font-weight-thin">{{}}</del></p>
              <v-spacer></v-spacer>
            ...
            <p class="title" v-if="show==true">Lựa chọn</p>
            <v-radio-group v-if="show == true" v-model="row" row>
          ...
          <v-tabs>
            ...
            <v-tab-item>
              <p class="pt-10 subtitle-1 font-weight-thin">
                {{ product.content.desMain }}
              </p>
            </v-tab-item>
            <v-tab-item>
              <p class="pt-10 subtitle-1 font-weight-thin">
                {{ product.content.des2 }}
              </p>
            </v-tab-item>
            <v-tab-item>
              <v-list
...
<script>
    export default {
        data: () => ({
            ...
            product:{
              content:{
                desMain: 'sản phẩm được nhập khẩu từ nhật với chất lượng cao'
              }
            },
            breadcrums: [
                {
